...
router.get("/scrape", function (req, res) {
    ...
    request("https://www.reuters.com/news/archive", function (error, response, html) {
        ...
        $(".news-headline-list").each(function (i, element) {
            ...
            result.title = $(this).children(".story").children(".story-content").children("a").children(".story-title").html();
            // result.description saves text description
            result.description = $(this).children(".story").children(".story-content").children("p").html();
